        ...
        <Row className="text-center">
          ...
          <Col>
            <Details
              ...
              description="Site includes search feature to easily
find desired merchandise. It also
has live chat and customer service to facilitate the process. Your
company also gets a dedicated account manager for support and product offeringssing a unique company ID and email address/Voucher ID. They can quickly glance through what they want and place the order."
              features={[]}
            />
          </Col>
          <Col>
