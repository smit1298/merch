        ...
        <Row className="text-center">
          ...
          <Col>
            <Details
              ...
              description="Designed to work easily on
smartphones payment gateway integration for credit card and account transfer. We also use a voucher system that can be invoiced and pay at the end of the month."
              features={[]}
            />
          </Col>
        </Row>
