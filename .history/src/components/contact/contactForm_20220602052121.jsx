...
function ContactForm() {
  ...
  return (
    <Container>
      <Row>
        <Col className="form-container justify-content-center text-center">
          <h6>Contact us</h6>
          <h1 className="text-center justify-content-center">Get in touch</h1>
          ...
          <form className="register-form" onSubmit={handleSubmit}>
            ...
            <input type="text" name="message" value={values.message} /> <br /> <br />
