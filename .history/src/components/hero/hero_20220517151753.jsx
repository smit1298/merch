    ...
    <div className="container-hero">
      <div className="row">
        <section className="col get-started w-100">
            <p style={{color: "#DBA90F", backgroundColor: "#F1EBDA", width: "60%", borderRadius: "10px", padding}}> <span style={{borderRadius: ""}}>What’s new?</span> <span>Get 10% of your next Merch Buy</span></p>
