    ...
    <>
      <Container id="benefit">
        ...
        <Row className="pb-5 text-center">
          ...
          <Col className="col-lg-4">
            <Detail
              Im="./Assets/icons/smartphone.png"
