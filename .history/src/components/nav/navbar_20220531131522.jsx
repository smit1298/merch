  ...
  return (
    <Navbar className="general shadow-sm" bg="white" expand="lg">
      <Container className="nav-container">
        <Navbar.Brand className="logo me-5" to="/">
          <img src="./Assets/images/logo.jpg" alt="Merch_logo_image" />
          <p style={{display: "none"}} className="merch-name">Merch.xyz</p>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: "150px" }}>
            ...
            <Nav.Link to="#action2">Contact us</Nav.Link>
          </Nav>

          <Nav className="ms-auto my-2 my-lg-0">
            <Nav.Link className="me-3" to="/shop">
              Shop now
            </Nav.Link>
