      ...
      <Container className="nav-container">
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: "150px" }}>
            <Nav.Link>
              <Link className={Buttons === "home" ? "link-home nav-link" : "nav-link" } to="/" onClick={() => ButtonSetter("home")}>
                Home
              </Link>
            </Nav.Link>
            <Nav.Link>
              <Link className={Buttons === "contact" ? "link-contact nav-link" : "nav-link" } to="/contact" onClick={() => ButtonSetter("contact")}>
                Contact us
              </Link>
            </Nav.Link>
          </Nav>
